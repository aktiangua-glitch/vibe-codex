...
设备目前未连接，因此本轮只完成了构建和电脑端真实联调，尚未把这版固件烧进
实机。软件已准备好；下一步才需要重新接 USB。
...
- ESP32 固件完整构建成功
- RAM：175,276 / 327,680 bytes（53.5%）
- Flash：2,236,012 / 8,388,608 bytes（26.7%）
...
- 实机尚未烧录和做 Wi-Fi/麦克风端到端测试，因为设备在实现期间已拔线。
