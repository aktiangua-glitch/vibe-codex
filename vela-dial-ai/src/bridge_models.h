...
struct BridgeSession {
    char thread_id[VELA_THREAD_ID_BYTES];
    char title[48];
    // Keep a substantial latest reply for the detail page. The device wraps
    // it into a compact multi-line viewport and scrolls the full text rather
    // than silently reducing it to the short session-list preview.
    char summary[768];
